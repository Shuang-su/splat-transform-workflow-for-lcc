...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Merge a simple v1 settings.json with a base v2 settings file, "
            "or convert a standalone v1 settings.json into v2."
        )
    )
    ...
    parser.add_argument(
        ...
        dest="v2_settings",
        type=Path,
        help="Optional base version 2 settings JSON to preserve annotations and other viewer config",
    )
